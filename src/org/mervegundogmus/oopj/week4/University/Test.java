package org.mervegundogmus.oopj.week4.University;
...
public class Test {
	...
	public static void main(String[] args) {
        ...
        professor1.name = "James Ford";
        
        Course course1 = new Course();
        course1.name = "Int. to Software Engineering";
        
        Student student1 = new Student();
        student1.name = "Jack Sheapard";
        
        Classroom classroom1 = new Classroom();
        classroom1.name = "Z-402";
        
        // Head of Software Engineering department is James Ford and consequently his department is Software Engineering.
        ...
        classroom1.coursesPlace = new Course[7];
        classroom1.coursesPlace[0] = course1;
